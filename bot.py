...
async def letter(ctx, txt):
    ...
    '14. 8월 10일 화요일 3주 2일차',
    '15. 8월 11일 수요일 3주 3일차',
    ...
    '17. 8월 13일 금요일 3주 5일차',
    '18. 8월 14일 토요일 3주 6일차',
    ...
    '25. 8월 21일 토요일 4주 6일차',
    '26. 8월 22일 일요일 4주 7일차.',
    '27. 8월 23일 월요일 5주 1일차',
    '28. 8월 24일 화요일 5주 2일차',
    ...
    '32. 8월 28일 토요일 5주 6일차',
    '33. 8월 29일 일요일 5주 7일차',
...
async def order(ctx):
    ...
    embed.add_field(name='letter', value='[\'편지\', \'할 말\'] + [\'오늘\', \'전체\', \'모두\']', inline=False)
